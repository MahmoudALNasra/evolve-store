...
const FREE_SHIPPING_MAX_RATE = 15
const EXTENDED_FREE_SHIPPING_THRESHOLD = 200
const EXTENDED_FREE_SHIPPING_MAX_RATE = 50
const SHIPPING_RATE_MARKUP = 2
...
function getFreeShippingMinimumSubtotal(rate) {
...
function isFreeShippingEligible(subtotal, rate) {
